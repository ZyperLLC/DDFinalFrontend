...
export default function Profile() {
        ...
        <div className="flex flex-row items-center mb-6 w-full max-w-[520px] mx-auto px-4" style={{ gap: '20px' }}>
          <div className="relative" style={{ width: '75%' }}>
            <input
              ...
              className="w-full h-[50px] bg-[rgba(255,255,255,0.08)] border border-[rgba(255,255,255,0.15)] 
  ...
  transition-all backdrop-blur-[10px] "
          ...
          <button
            ...
            className="h-[50px] px-6 bg-[rgba(255,255,255,0.08)] border border-[rgba(255,255,255,0.15)] 
  rounded-[10px] text-white hover:bg-[rgba(255,255,255,0.15)] hover:scale-105 
  hover:border-white transition-all font-medium backdrop-blur-[2px] whitespace-nowrap w-[25%] text-lg"
            style={{
              color: 'white',
              fontSize: '16px',
              width: '25%'
