  ...
  return (
    ...
    >
      ...
      <SectionBox title={t('profile.gameHistory')}>
        ...
        <div className="w-full max-w-[520px] mx-auto bg-[#232358] rounded-2xl p-7 sm:p-9 shadow-xl"
          style={{ background: "rgba(35,35,88,0.92)" }}>

          {/* ✅ UPDATED Draw Info */}
          {filteredBets.length !== 0 && (
            <div
              className="w-full rounded-[12px] px-6 py-4 flex justify-between items-center mb-6"
              style={{
          ...
          <div
            className="flex items-center justify-between mt-8 px-4 py-3 rounded-lg"
            style={{
