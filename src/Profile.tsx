...
<div 
  className="font-semibold mb-2 flex items-center gap-2 text-[22px] ml-6 mt-4" 
  style={{ color: 'white' }}
>
...
<button
  ...
  className="flex-1 min-h-[56px] rounded-[5px] border-2 border-white text-white font-medium 
