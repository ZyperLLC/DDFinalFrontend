      ...
      <SectionBox title={t('profile.gameHistory')}>
        ...
        <div className="flex flex-row items-center mb-6 w-full max-w-[520px] mx-auto px-4" style={{ gap: '20px' }}>
          ...
          <button
            ...
            className="h-12 px-6 bg-[rgba(255,255,255,0.08)] border border-[rgba(255,255,255,0.15)] rounded-[10px] text-white hover:bg-[rgba(255,255,255,0.15)] hover:scale-105 hover:border-white transition-all font-medium backdrop-blur-[10px] whitespace-nowrap"
            style={{ color: 'white', fontSize: '16px', width: '25%' }}
          >
            Filters
          </button>
        </div>
        ...
        <div className="w-full max-w-[520px] mx-auto bg-[#232358] rounded-2xl p-5 sm:p-7 shadow-xl"
          ...
          {filteredBets.length === 0 ? (
            ...
            <div className="flex flex-col gap-3">
              {/* ✅ UPDATED Draw Info (shifted right with padding) */}
              <div
                className="font-semibold text-[22px] mb-4 px-6 py-3 rounded-md"
                style={{
          ...
          {/* Navigation Buttons */}
          <div className="flex items-center justify-between mt-6 w-full px-4 py-3 rounded-lg" style={{ gap: '12px', background: "rgba(255,255,255,0.05)" }}>
            <button
              onClick={() => alert('Prev Draw clicked')}
              className="flex-1 h-12 rounded-[6px] border border-[rgba(255,255,255,0.2)] text-white font-medium bg-[rgba(255,255,255,0.05)] hover:bg-[rgba(255,255,255,0.15)] transition-all"
            >
              ← Prev Draw
            </button>
            <button
              onClick={() => alert('Jump to Round clicked')}
              className="flex-1 h-12 rounded-[6px] border-2 border-white text-white font-medium bg-[rgba(255,255,255,0.08)] hover:bg-[rgba(255,255,255,0.15)] transition-all"
            >
              Jump to Round
            </button>
            <button
